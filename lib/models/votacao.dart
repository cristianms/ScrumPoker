...
class Votacao {
  ...
  String? hashUsuario;
  int? nota;
  Votacao({this.hashSala, this.hashUsuario, this.nota});

  Votacao copyWith({String? hashSala, String? hashUsuario, int? nota}) {
    return Votacao(
  ...
  Map<String, dynamic> toMap() {
    return {'hashSala': hashSala, 'hashUsuario': hashUsuario, 'nota': nota};
  }
  ...
  factory Votacao.fromJson(String source) =>
      Votacao.fromMap(json.decode(source));

  @override
  String toString() =>
      'Votacao(hashSala: $hashSala, hashUsuario: $hashUsuario, nota: $nota)';
